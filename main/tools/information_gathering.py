...
from main.tools import run_on_browser,banner,waiting
...
def Nmap():
    while True:
        ...
        if ask=="1":
            ...
            writeup({"Nmap Cheat-Sheet":"https://www.stationx.net/nmap-cheat-sheet/","Official website":"https://nmap.org/ ","Other resources":"https://linux.die.net/man/1/nmap"},"Nmap")
        else:
            return
        # waiting.waiting()
def Maltego():
    while True:
        ...
        if ask=="1":
            ...
            #first argument for dictionary(key=title,value=url) second argument for banner 
            writeup({"Official website":"https://www.maltego.com/ ","How to use it":"https://www.geeksforgeeks.org/maltego-tool-in-kali-linux/ ","Other resources":"https://www.cyberpratibha.com/information-gathering-with-maltego/ "},"Maltego")
        else:
            return
def Dracnmap():
    while True:
        ...
        if ask == "1":
            ...
            writeup({"How to use":"https://www.geeksforgeeks.org/dracnmap-information-gathering-and-network-exploitation-tool/ ","Other resources":"https://www.hacking.land/2016/10/dracnmap-exploit-network-and-gathering.html?utm_source=dlvr.it&utm_medium=facebook&m=1 "},"Dracnmap")
        else:
            return
def RED_HAWK():
    while True:
        ...
        if ask == "1":
            ...
            writeup({"How to use":"https://systemweakness.com/red-hawk-an-information-gathering-tool-d12a66da7c63 ","Other resources":"https://www.geeksforgeeks.org/red-hawk-information-gathering-and-vulnerability-scanning-tool-in-kali-linux/ "},"RED HAWK")
        else:
            return
def Th3inspector():
    while True:
        ...
        if ask == "1":
            ...
            writeup({"github description":"https://github.com/Moham3dRiahi/Th3inspector ","First resource":"https://www.geeksforgeeks.org/red-hawk-information-gathering-and-vulnerability-scanning-tool-in-kali-linux/ ","Second resource":"https://pentesttools.net/th3inspector-tool-for-information-gathering/"},"Th3inspector")
        else:
            return
def Hping3():
    while True:
        ...
        if ask=="1":
            ...
            writeup({"First resource":"https://hacksheets.in/all-categories/useful-resources-main/hping3/"},"Hping3")
        else:
            return
def Arping():
    while True:
        ...
        if ask=="1":
            ...
            writeup({"First resource":"https://hacksheets.in/all-categories/useful-resources-main/hping3/"},"Arping")
        else:
            return
def Netdiscover():
    while True:
...
def Wafw00f():
    while True:
        ...
        if ask=="1":
            ...
            writeup({"First resource":"https://www.briskinfosec.com/tooloftheday/toolofthedaydetail/wafw00f-tool-to-fingerprint-and-identify-web-application-firewall","Second resource":"https://null-byte.wonderhowto.com/how-to/identify-web-application-firewalls-with-wafw00f-nmap-0198145/"},"Wafw00f")
        else:
            return
def tool_options():
