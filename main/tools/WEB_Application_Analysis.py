            ...
            if ask=="1":
                    ...
                    if professional=="y" or professional=="Y" or professional=="Yes" or professional=="yes":
                        ...
                        if isExist:
                            ...
                            if professional=="y" or professional=="Y" or professional=="Yes" or professional=="yes":
                                os.system('cd Burp-Suite && (java -jar keygen.jar) ; sleep 3s && echo "Executing Burp Suite Professional with Keyloader" && echo "java --illegal-access=permit -Dfile.encoding=utf-8 -javaagent:$(pwd)/loader.jar -noverify -jar $(pwd)/Burp_Suite_Pro.jar &" > burp')
