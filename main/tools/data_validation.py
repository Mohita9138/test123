...
from main.tools import banner,template,waiting,writeup,colors
import os
import requests
from bs4 import BeautifulSoup
    ...
    while True:
        ...
        if vulns == "0":
            while True:
                ...
                if ask == '1':
                    while True:
                        ...
                        banner.main()
                        banner.attack("XSS")
                        print(colors.red,"\n==> It is recommended to test manually for XSS vulnerability to get better understanding & results.\nCheck out the writeup section to to learn about Cross Site Scripting",colors.reset)
                        list_tools = ["Dalfox", "XSpear", "Xsser", "go back"]
                        for i in range(len(list_tools)):
                            print(colors.options,f"{i}) {list_tools[i]}".title(), colors.reset)
                        option = input(f"\n {colors.select}Select an Option ->{colors.reset} ")
                        if option == '0':
                            print("\n[+] Dalfox")
                            github = github_getting_text("https://github.com/hahwul/dalfox#how-to-install", 'p[dir="auto"]', 0)
                            ...
                            print("\n[+] XSStrike")
                            github = github_getting_text("https://github.com/s0md3v/XSStrike", 'p[dir=auto]', 1) 
                            ...
                            }, link="https://github.com/s0md3v/XSStrike.git", method="github")
                        elif option == '2':
                            print("\n[+] Xsser")
            ...
            while True:
                ...
                ask = vuln_options()
                if ask == '1':
                    print(colors.options,"\nNo tools available for this Vulnerability type.\nIt is recommended to test manually for HTML Injection to get better understanding & results.\nCheck out the writeup section to to learn about HTML Injection",colors.reset)
                    waiting.waiting()
                elif ask == '2':
                    writeup.writeup({'Comprehensive Guide on HTML Injection':'https://www.hackingarticles.in/comprehensive-guide-on-html-injection/',
            ...
            while True:
                ...
                if ask == '1':
                    ...
                    banner.main()
                    banner.attack("SQL Injection")
                    print(colors.red,"\n==> It is recommended to test manually for SQL Injection to get better understanding & results.\nCheck out the writeup section to to learn about SQL Injection",colors.reset)
            ...
            while True:
                ...
                if ask == '1':
                    ...
                    banner.main()
                    banner.attack("Command Injection")
                    print(colors.red,"\n==> It is recommended to test manually for Command Injection to get better understanding & results.\nCheck out the writeup section to to learn about Command Injection",colors.reset)
                    ...
                    if option == '0':
                        ...
                        }, link="https://github.com/commixproject/commix",method = "github")
                    else:
                        # print(f"{colors.red}[-]Wrong Input{colors.reset}")
                        break                 
                elif ask == '2':
            ...
            while True:
                ...
                ask = vuln_options()
                if ask == '1':
                    print(colors.options,"\nNo tools available for this Vulnerability type.\nIt is recommended to test manually for HTTP Req. Smuggling to get better understanding & results.\nCheck out the writeup section to to learn about HTTP Req. Smuggling",colors.reset)
                    waiting.waiting()
                elif ask == '2':
                    writeup.writeup({'HTTP request smuggling Explained':'https://infosecwriteups.com/http-request-smuggling-explained-and-exploited-part-0x1-89ce2956534f',
            ...
            while True:
                ...
                ask = vuln_options()
                if ask == '1':
                    print(colors.options,"\nNo tools available for this Vulnerability type.\nIt is recommended to test manually for HTTP Parameter Pollution to get better understanding & results.\nCheck out the writeup section to to learn about HTTP Parameter Pollution",colors.reset)
                    waiting.waiting()
                elif ask == '2':
                    writeup.writeup({'Behind the Scene : HTTP Parameter Pollution':'https://infosecwriteups.com/behind-the-scene-http-parameter-pollution-534b4fa2449c',
            ...
            while True:
                ...
                if ask == '1':
                    ...
                    banner.main()
                    banner.attack("Open Redirection")
                    print(colors.red,"\n==> It is recommended to test manually for Open Redirection to get better understanding & results.\nCheck out the writeup section to to learn about Open Redirection",colors.reset)
                    ...
                    if option == '0':
                        ...
                        }, link="https://github.com/devanshbatham/OpenRedireX", method="github")
                    elif option == '1':
                        print("\n[+] Oralyzer")
                        ...
                        }, link="https://github.com/r0075h3ll/Oralyzer", method="github")
                    else:
                        # print(f"{colors.red}[-]Wrong Input{colors.reset}")
                        break
                elif ask == '2':
            ...
            while True:
                ...
                ask = vuln_options()
                if ask == '1':
                    print(colors.options,"\nNo tools available for this Vulnerability type.\nIt is recommended to test manually for LFI to get better understanding & results.\nCheck out the writeup section to to learn about Local File Inclusion",colors.reset)
                    waiting.waiting()
                elif ask == '2':
                    writeup.writeup({'LFI Attack Examples':'https://brightsec.com/blog/lfi-attack-real-life-attacks-and-attack-examples/',
